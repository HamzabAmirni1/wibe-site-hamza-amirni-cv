...
const ImpactTemplate: React.FC<ImpactTemplateProps> = ({ data, template }) => {
  ...
  return (
    ...
    >
      <div className="w-full bg-slate-50 -mx-[35px] px-[35px] py-12 mb-12 border-l-8 border-primary">
        {renderSection("basic")}
      </div>
      <div className="w-full">
        {enabledSections.filter(s => s.id !== 'basic').map((section) => (
